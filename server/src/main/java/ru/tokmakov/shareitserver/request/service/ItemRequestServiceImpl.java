...
import ru.tokmakov.shareitserver.request.model.ItemRequestMapper;
...
public class ItemRequestServiceImpl implements ItemRequestService {
    ...
    public List<ItemRequestDto> findByUserId(long userId) {
        ...
        List<ItemRequestDto> itemRequestDtos = itemRequests.stream()
                .map(itemRequest -> {
                    ...
                    dto.setItems(ItemMapper.itemsToDtos(itemsByRequestId.getOrDefault(itemRequest.getId(), Collections.emptyList())));
                    return dto;
                })
                .toList();
    ...
    public ItemRequestDto findById(long requestId) {
        ...
        itemRequestDto.setItems(ItemMapper.itemsToDtos(items));
