...
import ru.tokmakov.shareitserver.item.model.CommentMapper;
...
public class ItemServiceImpl implements ItemService {
    ...
    public Item save(ItemDto itemDto, long userId) {
        ...
        item.setOwner(user);
        log.info("ItemServiceImpl: setting owner for item: {} to user with id: {}", item, userId);
    ...
    public ItemWithCommentsDto findById(long itemId) {
        ...
        List<Comment> commentByItemId = commentRepository.findByItemId(itemId);
        itemWithCommentsDto.setComments(CommentMapper.commentsToCommentsDto(commentByItemId));
